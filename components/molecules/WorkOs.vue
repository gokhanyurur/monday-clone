<template>
    <div>
                    ...
                    <div class="item item-1 timeline">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('timeline_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('timeline_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-2 status">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('status_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('status_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-3 battery">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('battery_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('battery_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-4 integration">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('integration_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('integration_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-5 pie">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('pie_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('pie_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-6 mobileapp">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('mobileapp_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('mobileapp_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-7 automation">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('automation_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('automation_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                    <div class="item item-8 talk">
                        <div class="asset-inner">
                            <div class="video-component">
                                <video
                                    preload="auto"
                                    :poster="this.$helpers.getImgUrl('talk_column.png', '/video-posters')"
                                    style="width: 100%; height: 100%"
                                    muted
                                >
                                    <source :src="this.$helpers.getVideo('talk_column.mp4')" />
                                </video>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="window-content">
                                <div class="asset-inner">
                                    <div class="video-component">
                                        <video
                                            preload="auto"
                                            :poster="this.$helpers.getImgUrl('dashboard_column.png', '/video-posters')"
                                            style="width: 100%; height: 100%"
                                            muted
                                        >
                                            <source :src="this.$helpers.getVideo('dashboard_column.mp4')" />
                                        </video>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="m__container work-os-mobile">
            <img :src="this.$helpers.getImgUrl('workos-mobile-img.png')" width="100%" height="auto" alt="WorkOs Mobile Image" />
        </div>
    </div>
</template>
